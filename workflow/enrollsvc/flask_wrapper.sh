...
UWSGI=${HCP_RUN_ENROLL_UWSGI:=uwsgi_python3}
PORT=${HCP_RUN_ENROLL_UWSGI_PORT:=5000}
STATS=$((HCP_RUN_ENROLL_UWSGI_PORT+1))
UWSGI_FLAGS=${HCP_RUN_ENROLL_UWSGI_FLAGS:=--http :$HCP_RUN_ENROLL_UWSGI_PORT --stats :$STATS}
UWSGI_OPTS=${HCP_RUN_ENROLL_UWSGI_OPTIONS:=--processes 2 --threads 2}
